...
heavy_rep_min, heavy_rep_max, break_under_min, core, superset_type, superset_ID, build_type)
  VALUES ("Incline Press", 4, 5, 8, 12, 4, 6, 1, 1, 'Bicep', 2, "Bulk");

INSERT INTO chest (name, set_min, set_max, light_rep_min, light_rep_max, 
heavy_rep_min, heavy_rep_max, break_under_min, core, superset_type, superset_ID, build_type)
  VALUES ("Flat Press", 4, 5, 8, 12, 4, 6, 1, 1, 'Bicep', 2, "Bulk");

INSERT INTO chest (name, set_min, set_max, light_rep_min, light_rep_max, 
heavy_rep_min, heavy_rep_max, break_under_min, core, superset_type, superset_ID, build_type)
  VALUES ("Decline Press", 4, 5, 8, 12, 4, 8, 1, 1, 'Bicep', 2, "Bulk");

INSERT INTO chest (name, set_min, set_max, light_rep_min, light_rep_max, 
heavy_rep_min, heavy_rep_max, break_under_min, core, superset_type, superset_ID, build_type)
  VALUES ("Chest Flyes", 3, 4, 15, 20, 5, 10, 1, 0, 'Chest', 5, "Tone");
